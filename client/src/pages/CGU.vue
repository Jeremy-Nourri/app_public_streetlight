<template>
    <div class="cgu">
      <h1>Conditions Générales d'Utilisation du site CitizyenElectrical</h1>
      ...
      <section v-for="(article, index) in articles" :key="index">
        ...
        <ul v-if="article.list">
          <li v-for="(item, index) in article.list" :key="index">{{ item }}</li>
        </ul>
      </section>
      <a href="/client/src/pages/StreetlightPage.vue">Retour à l'accueil</a>
    </div>
  </template>
        ...
        articles: [
          {
            ...
            content: [
              "Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site CitizyenElectrical. Constituant le contrat entre la société CitizyenElectrical, l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces CGU. L’accès à cette plateforme signifie l’acceptation des présentes CGU."
            ]
          },
          {
            title: "Article 2 : Mentions légales",
            content: [
              "L'édition du site CitizyenElectrical est assurée par la société CitizyenElectrical."
            ]
          },
          {
            title: "Article 3 : Accès au site",
            content: [
              "Le site CitizyenElectrical permet d'accéder gratuitement aux services suivants :"
            ],
            list: [
          ...
          },
          {
            ...
            list: ["Le formulaire de contact", "Son espace client"]
          },
          {
            title: "Article 5 : Propriété intellectuelle",
            content: [
              "Les marques, logos ainsi que les contenus du site CitizyenElectrical (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.",
          ...
          },
          {
            ...
            content: [
              ...
              "L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site CitizyenElectrical.",
              "En naviguant sur le site, l’Utilisateur accepte les cookies. Leur désactivation peut s’effectuer via les paramètres du logiciel de navigation. L'utilisateur peut refuser les cookies via un bandeau disponible lors de la première connexion au site CitizyenElectrical."
            ]
          },
          {
            ...
            content: [
              ...
              "Le site ne peut être tenu pour responsable en cas de retard causé par la force majeure ou en raison de catastrophes naturelles. Le site ne peut aussi être tenu pour responsable en cas de retard ou annulation dus à l'intervention d'un tiers."
            ]
          },
          {
            title: "Article 8 : Durée du contrat",
            content: [
              ...
              "L'utilisateur peut à tout moment résilier son compte et ses données seront supprimées en fonction. L'utilisateur peut supprimer son compte en cliquant sur le bouton supprimer le profil situé dans l'onglet **Paramètres**"
            ]
          },
          {
